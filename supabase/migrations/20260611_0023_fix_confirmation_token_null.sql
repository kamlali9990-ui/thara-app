-- Fix: set confirmation_token = '' instead of NULL in create_customer_auth_rpc
-- GoTrue signIn expects empty string, not NULL
...
-- Fix existing RPC-created users that have NULL confirmation_token
UPDATE auth.users
