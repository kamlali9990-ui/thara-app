...
const AppHeader = memo<AppHeaderProps>(({ cartCount, onCartOpen, tab, searchQuery, setSearchQuery, unreadNotifs, onMenuClick, onNotifClick, theme, siteStats, hideSearch }) => (
  <header className="app-header-new">
    <div className="app-header-new-inner">
      ...
      <div className="app-logo-new">
        <img src={theme === 'dark' ? logoPathDark : logoPath} alt="أسواق ثراء الشرق ون" className={`app-logo-img-new ${theme === 'dark' ? 'logo-dark' : 'logo-light'}`} onError={(e: any) => { e.target.src = imgFallback(90, 90, '#127443', theme === 'dark' ? '#020f08' : '#ffffff', 'ث'); }} />
      </div>
