...
const ROLE_MAP: Record<string, string> = { admin: 'admin', manager: 'manager', employee: 'employee', driver: 'driver' };
...
const ROLE_LABELS: Record<string, string> = { admin: 'مدير', manager: 'مدير عام', employee: 'موظف', driver: 'كابتن' };

export default function AdminInstructions({ staffRole }: { staffRole: StaffRole }) {
