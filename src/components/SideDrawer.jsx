    ...
    <div className={`side-drawer ${isOpen ? 'open' : ''}`}>
      <div className="side-drawer-header">
        <div className="side-drawer-logo-wrap">
          <img src={theme === 'dark' ? logoPathDark : logoPath} alt="ثرا" className={`side-drawer-logo ${theme === 'dark' ? 'logo-dark' : 'logo-light'}`} onError={(e) => { e.target.src = imgFallback(80, 80, '#127443', theme === 'dark' ? '#21252b' : '#ffffff', 'ث'); }} />
        </div>
