    ...
    <div className={`side-drawer ${isOpen ? 'open' : ''}`}>
      <div className="side-drawer-header">
        <div className="side-drawer-logo-wrap">
          <img src={theme === 'dark' ? logoPathDark : logoPath} alt="ثرا" className={`side-drawer-logo ${theme === 'dark' ? 'logo-dark' : 'logo-light'}`} onError={(e) => { e.target.src = imgFallback(80, 80, '#127443', theme === 'dark' ? '#020f08' : '#ffffff', 'ث'); }} />
        </div>
      ...
      <div className="side-drawer-items">
        ...
        <button className="side-drawer-item" onClick={() => { onClose(); window.dispatchEvent(new CustomEvent('show-pwa-install-prompt')); }}>
