...
BEGIN
  ...
  ('عطر أسود العربية للعود (50 مل)', 'العطور', 89, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-arabian-black.jpg', 30, 'زجاجة'),
  ('عطر المسك الذهبي (75 مل)', 'العطور', 65, 49, TRUE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-gold-musk.jpg', 35, 'زجاجة'),
  ('عطر ورد الطائف (50 مل)', 'العطور', 75, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-taif-rose.jpg', 25, 'زجاجة'),
  ('دهن عود ملكي (12 مل)', 'العطور', 120, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-royal-oud.jpg', 20, 'زجاجة'),
  ('عطر بخور دوسري (50 مل)', 'العطور', 55, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-dosari.jpg', 40, 'زجاجة'),
  ('عطر العنبر الفاخر (50 مل)', 'العطور', 85, 69, TRUE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-amber.jpg', 30, 'زجاجة'),
  ('عطر الياسمين الدمشقي (50 مل)', 'العطور', 70, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-jasmine.jpg', 28, 'زجاجة'),
  ('مخمرية عطرية فاخرة (200 مل)', 'العطور', 40, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-body-spray.jpg', 45, 'زجاجة'),
  ('عطر العود الهندي (30 مل)', 'العطور', 150, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-indian-oud.jpg', 15, 'زجاجة'),
  ('عطر خشب الصندل (50 مل)', 'العطور', 95, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-sandalwood.jpg', 22, 'زجاجة'),
  ('عطر فانيلا ومسك (50 مل)', 'العطور', 60, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-vanilla-musk.jpg', 30, 'زجاجة'),
  ('عطر البحر المتوسط (100 مل)', 'العطور', 110, 89, TRUE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-mediterranean.jpg', 18, 'زجاجة'),
  ('مخلطة عطور عربية فاخرة (50 مل)', 'العطور', 80, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-arabic-blend.jpg', 25, 'زجاجة'),
  ('عطر الليل (50 مل)', 'العطور', 78, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-night.jpg', 20, 'زجاجة'),
  ('عطر زهور البرتقال (50 مل)', 'العطور', 68, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-orange-blossom.jpg', 32, 'زجاجة'),
  ('بخور عود ملكي (100 جرام)', 'العطور', 45, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-incense.jpg', 25, 'علبة'),
  ('معطر جو فاخر (300 مل)', 'العطور', 25, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-air-freshener.jpg', 40, 'زجاجة'),
  ('عطر تفاح أخضر (50 مل)', 'العطور', 50, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-green-apple.jpg', 35, 'زجاجة'),
  ('عطر قهوة وعود (50 مل)', 'العطور', 88, NULL, FALSE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-coffee-oud.jpg', 20, 'زجاجة'),
  ('عطر نسائي فاخر (75 مل)', 'العطور', 95, 79, TRUE, 'https://res.cloudinary.com/dvnhgvdd1/image/upload/v1/thara/perfume-women-luxury.jpg', 28, 'زجاجة');
  END IF;
END $$;
