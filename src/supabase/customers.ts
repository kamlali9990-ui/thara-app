...
export const customersApi = {
  async create(email: string, name: string, phone: string, username?: string | null, realEmail?: string | null) {
  ...
  async update(email: string, name: string, phone: string, deliveryAddress?: string | null, neighborhood?: string | null, location?: string | null, username?: string | null, realEmail?: string | null) {
  ...
  async resolveLogin(identifier: string) {
  ...
  async findByRealEmail(realEmail: string) {
