...
describe('customersApi', () => {
  ...
  describe('create', () => {
    it('calls create_customer_rpc', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('create_customer_rpc', { p_email: 'a@a.com', p_name: 'A', p_phone: '966500000', p_username: null, p_real_email: null });
  ...
  describe('update', () => {
    it('calls update_customer_rpc with basic fields', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('update_customer_rpc', {
        ...
        p_delivery_address: null, p_neighborhood: null, p_location: null, p_username: null, p_real_email: null
      });
    });
    ...
    it('calls update_customer_rpc with all fields', async () => {
      ...
      expect(mockRpc).toHaveBeenCalledWith('update_customer_rpc', {
        p_email: 'c@c.com', p_name: 'Updated', p_phone: '966511111',
        p_delivery_address: 'شارع ١', p_neighborhood: 'العزيزية', p_location: '{"lat":28.42,"lng":48.5}', p_username: null, p_real_email: null
      });
    });
  });
